...
const Roadmap = () => {
	...
	return (
		...
		<section id="roadmap">
			...
			<div className="roadmap-box scrollme" $scrollme >
			...
			<div className="roadmap-right-line i-v roadmap-line">
				<img src={require('../../assets/images/roadmap-right-line.png')} alt="roadmap-right-line" />
			</div>

			<div className="roadmap-box roadmap-flip scrollme" $scrollme>
				<div className="animateme" data-when="span" data-from="0.5" data-to="0" data-opacity="0" data-translatex="-700"
					data-scale="0.5">
			...
			<div className="roadmap-left-line i-v roadmap-line-opposite">
				<img src={require('../../assets/images/roadmap-left-line.png')} alt="roadmap-left-line" />
			</div>
			...
			<div className="roadmap-right-line i-v roadmap-line">
				<img src={require('../../assets/images/roadmap-right-line-incomplete.png')} alt="roadmap-right-line-incomplete" />
			</div>
